...
export default function GameCanvas({ theme, questionTheme, answeredCorrectly }) {
    ...
    const getThemeElements = ()=>{
        ...
        // Di�? fırçalama teması
        if (questionTheme.includes('di�?') || questionTheme.includes('a�?ız')) {
        ...
        // Banyo/du�? teması
        if (questionTheme.includes('banyo') || questionTheme.includes('du�?')) {
            elements.push(/*#__PURE__*/ _jsxDEV("div", {
        ...
        // A�?aç ö�?eleri kaldırıldı (gereksiz görsel yük) - temiz arayüz için.
        // �?alılar ve küçük bitkiler (plant-line) kaldırıldı �?? sadele�?tirme.
        // �?içekler ve çimler
        const flowers = [
            {
                left: '3%',
        ...
        // Kelebek ve böcek animasyonları kaldırıldı (gösterilmeyecek)
        // Ta�?lar ve kayalar
        const rocks = [
            {
                left: '10%',
